...
if (isset($_POST['login'])) {
    ...
    $result = mysqli_query($conn, "SELECT * FROM users WHERE gmail='$email' AND password='$password'");
                        ...
                        <form action="" class="mt-4" method="POST">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control" name="gmail" placeholder="example@company.com" id="email" autofocus required>
                                </div>
                            </div>
                            <!-- End of Form -->
